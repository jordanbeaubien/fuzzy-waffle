...
Jordan Beaubien for Andrew Dool.
May 30th, 2023
'''
...
provinces = ["AB", "BC", "MN", "NB", "NF", "NS", "ON", "PE", "QC", "SK"]

# cities_by_province = { city : [ five most populated cities in province ] }
cities_by_province = { "AB"              : ["Calgary", "Edmonton", "Red Deer", "Lethbridge", "Airdrie"],
                       "BC"     : ["Vancouver", "Victoria", "Kelowna", "Abbotsford", "White Rock"],
                       "MN"             : ["Winnipeg", "Brandon", "Steinbach", "Springfield", "Winkler"],
                       "NB"        : ["Moncton", "Saint John", "Fredericton", "Dieppe", "Riverview"],
                       "NF"         : ["St. John''s", "Conception Bay South", "Paradise", "Mount Pearl", "Corner Brook"],
                       "NS"          : ["Halifax", "Cape Breton", "Lunenburg", "East Hants", "West Hants"],
                       "ON"              : ["Toronto", "Ottawa", "Mississauga", "Brampton", "Hamilton"],
                       "PE" : ["Charlottetown", "Summerside", "Cornwall", "Montague", "Kensington"],
                       "QC"               : ["Montréal", "Québec City", "Laval", "Gatineau", "Longueuil"],
                       "SK"         : ["Saskatoon", "Regina", "Prince Albert", "Moose Jaw", "Lloydminster"] }
